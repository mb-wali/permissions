...
//
// To ensure default values, the struct must have been initialized with NewBySubjectParams() beforehand.
...
func (o *BySubjectParams) bindLookup(rawData []string, hasKey bool, formats strfmt.Registry) error {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewBySubjectParams()
		return nil
	}
