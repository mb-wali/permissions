...
//
// To ensure default values, the struct must have been initialized with NewDeleteSubjectByExternalIDParams() beforehand.
...
func (o *DeleteSubjectByExternalIDParams) bindSubjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
		return errors.Required("subject_id", "query", rawData)
	}
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteSubjectByExternalIDParams) bindSubjectType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
		return errors.Required("subject_type", "query", rawData)
	}
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
...
func (o *DeleteSubjectByExternalIDParams) validateSubjectType(formats strfmt.Registry) error {
	...
	if err := validate.EnumCase("subject_type", "query", o.SubjectType, []interface{}{"user", "group"}, true); err != nil {
		return err
	}
